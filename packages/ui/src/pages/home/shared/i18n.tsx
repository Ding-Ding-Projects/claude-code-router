...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  ...
  zh: {
    ...
    text: {
      ...
      "Claude Design Desktop migration": "Claude Design Desktop 迁移",
      "Export selected legacy projects into a versioned ZIP. Nothing is disabled or deleted automatically.": "将选定的旧项目导出为有版本的 ZIP。不会自动停用或删除任何内容。",
      "Export migration archive": "导出迁移归档",
      "Migration export is available in the Electron app.": "迁移导出仅在 Electron App 中可用。",
      "Migration archive exported": "迁移归档已导出",
