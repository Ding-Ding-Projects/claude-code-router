...
contextBridge.exposeInMainWorld("ccr", {
  ...
  exportClaudeDesignMigration: () => invoke(IPC_CHANNELS.appExportClaudeDesignMigration) as Promise<ClaudeDesignMigrationExportResult>,
  getClaudeDesignMigrationStatus: () => invoke(IPC_CHANNELS.appGetClaudeDesignMigrationStatus) as Promise<ClaudeDesignMigrationStatus>,
