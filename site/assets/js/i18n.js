...
export const DICT = {
  ...
  'home.card.settings.body': { en: 'Theme, language, typography, colours, notifications — all customizable, all local.', zh: '主題、語言、字體、顏色、通知——全部可以自訂，全部只存本機。' },
  ...
  'palette.noMatch': { en: 'No commands match this query.', zh: '冇指令符合呢個搜尋。' },
  ...
  'tabs.bulk.none': { en: 'No tabs match. Nothing will close.', zh: '冇分頁符合，唔會閂任何嘢。' },
  ...
  'results.none': { en: 'Nothing matches this filter.', zh: '冇嘢符合呢個篩選。' },
  ...
  'notify.centre.empty': { en: 'No notifications yet. Errors and warnings stay here until you clear them.', zh: '暫時冇通知。錯誤同警告會留喺度直到你清走。' },
